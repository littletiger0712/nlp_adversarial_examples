...
# glove2 = glove_utils.loadGloveModel('counter-fitted-vectors-chinese.txt')
# create embeddings matrix for our vocabulary
counter_embeddings, missed = glove_utils.create_embeddings_matrix(glove_model, imdb_dataset.dict, imdb_dataset.full_dict)
